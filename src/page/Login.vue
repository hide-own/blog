<template>
  <div :class="{ container: true, 'sign-up-mode': register }">
      ...
      <div class="signin-signup">
        <form class="sign-in-form">
          ...
          <div class="input-field">
            ...
            <input
              v-model="captchaParam.captcha"
              type="text"
              placeholder="请输入验证码"
            />
            <button type="button" class="btn captcha" @click="getCaptcha">
              验证码
            </button>
          </div>
          <input
