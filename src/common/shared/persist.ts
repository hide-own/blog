 ...
 * @param defaultValue
 */
export function getPersist<K extends keyof Data>(key: K, defaultValue: Data[K] | null = null): Data[K] | null {
 ...
 */
export function setPersist<K extends keyof Data>(key: K, value: Data[K], expire: number | null = null): void {
