...
type MaybeElement = HTMLElement | SVGElement | import("vue").ComponentPublicInstance | undefined | null
...
/** 事件过滤器函数签名 */
type EventFilter<Args extends unknown[] = unknown[], This = unknown> = (invoke: VoidCallback, options?: (...args: Args) => This) => void
